...
@resultBuilder
public struct DeploymentDescriptor: Sendable {
    ...
    private init(
        ...
        dumpPackageAtExit(self.samDeploymentDescriptor)
    }
...
public protocol BuilderResource: Sendable {
...
public struct Function: BuilderResource {
    ...
    // 3. a default value
    static func packagePath(name: String, codeUri: String?, commandLine: CommandLineArgsFinderProtocol) throws -> String {
...
@resultBuilder
public enum CorsBuilder: Sendable {
...
public struct EventSources: Sendable {
...
public struct HttpApi: Sendable {
...
public struct EnvironmentVariables: Sendable {
